...
const Signup = () => {
  ...
  const [signUpError, setSignUpError] = useState("Sign Up Failed");
  ...
  return (
    <div>
      ...
      <Formik
        initialValues={{ email: "", password: "", password_confirm: "", username: ""   }}
        validate={(values) => {
          const errors = {};
          if (!values.email) {
            ...
            errors.password_confirm = "Your password does not match"
          }
